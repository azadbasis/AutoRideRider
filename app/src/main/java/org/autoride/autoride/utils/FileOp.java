...
public class FileOp extends Activity implements AppsConstants{
    ...
    public boolean checkSPHash() {
        ...
        pathSP = context.getFilesDir() + "/shared_prefs/" + SESSION_SHARED_PREFERENCES+ ".xml";
    ...
    private String getSPHash() {
        ...
        pathSP = context.getFilesDir().getParent() + "/shared_prefs/" +SESSION_SHARED_PREFERENCES + ".xml";
