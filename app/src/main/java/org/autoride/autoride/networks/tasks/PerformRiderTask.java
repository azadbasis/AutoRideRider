...
public class PerformRiderTask extends AsyncTask<String, Integer, RiderInfo> implements AppsConstants {
    ...
    public PerformRiderTask(String methods, String url, JSONObject postBody) {
